...
{    
    ...
    //  * @Path(/compounds)
    //  */
    // public function loadCompounds($id_membrane, $id_method)
    // {
    //     $substanceModel = new Substances();
    //     $data = $substanceModel->getSubstancesToStat($id_membrane, $id_method);
    //     return $data;
    // }
    ...
    //  * 
    //  * @PATH(/membrane/subcat)
    //  */
    // public function membrane_subcats($id_membrane)
    // {
    ...
    //     if(!$membrane->id)
    //     {
    //         ResponseBuilder::not_found("Invalid membrane id.");
    //     }
