...
class Curl_HTTP_Client
{
	 ...
	 * @param int timeout in sec for complete curl operation (default 60)
	 * @param boolean $xml - Is postdata in xml format?
	 * @return string data
	 * @access public
	 */
	function send_post_data($url, $postdata, $ip=null, $timeout=60, $xml = False)
	{
	 ...
	 * @param string ip address to bind (default null)
	 * @param int timeout in sec for complete curl operation (default 60 sec)
	 * @return string data
	 * @access public
	 */
