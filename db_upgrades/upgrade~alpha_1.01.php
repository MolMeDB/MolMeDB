...
(
    ...
    'ALTER TABLE `publications` ADD `pmid` INT NULL AFTER `doi`, ADD `title` TEXT NULL AFTER `pmid`, ADD `authors` TEXT NULL AFTER `title`, ADD `journal` TEXT NULL AFTER `authors`, ADD `page` VARCHAR(50) NULL AFTER `journal`, ADD `year` INT NULL AFTER `page`, ADD `publicated_date` DATETIME NULL AFTER `year`;',
    'ALTER TABLE `publications` DROP `editDateTime`;',
    'ALTER TABLE `publications` ADD `volume` VARCHAR(50) NOT NULL AFTER `journal`, ADD `issue` VARCHAR(50) NOT NULL AFTER `volume`;',
