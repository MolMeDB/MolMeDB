...
(
   ...
   WHERE id IN (
    ...
    "ALTER TABLE `files` ADD FOREIGN KEY (`id_user`) REFERENCES `users`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT; ALTER TABLE `files` ADD FOREIGN KEY (`id_validator_structure`) REFERENCES `validator_structure`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;",
);