...
(
    ...
    'ALTER TABLE `fragments_enum_types` ADD FOREIGN KEY (`id_enum_type`) REFERENCES `enum_types`(`id`) ON DELETE CASCADE ON UPDATE RESTRICT; ALTER TABLE `fragments_enum_types` ADD FOREIGN KEY (`id_fragment`) REFERENCES `fragments`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;',
