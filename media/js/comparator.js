...
function export_whole_dataset(name)
{
    ...
    var date = new Date();
    // Set header
    data[0] = ['Name', 'Identifier', 'SMILES', 'Method', 'Membrane','Q', 'Temperature', 'LogP', 'X_min', 'X_min_+/-', 'G_pen', 'G_pen_+/-', 'G_wat', 'G_wat_+/-', 'LogK', 'LogK_+/-', 'LogPerm', 
        'LogPerm_+/-', 'MW', 'Primary_reference', 'Secondary_reference', 'Pubchem', 'Drugbank'];
